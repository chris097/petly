...
const Banner = () => {
  return (
    <div className='bg-coreblue md:h-[770px] h-screen md:flex space-x-5 px-5 lg:px-20 relative'>
      ...
      <div className='flex-1 font-inter md:mt-28 pt-10'>
        ...
        <div className='h-[250px] bg-white hidden md:block absolute w-3/5 mt-24 p-6 rounded'>
      ...
      <div className='flex-1 mt-20'>
        <div className='flex justify-center'>
          <div>
            <div className='md:w-[227px] w-full h-[215px]'>
